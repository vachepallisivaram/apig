...
public class CorsConfiguration {
  ...
  private static final String ALLOWED_HEADERS = "x-requested-with, authorization, Content-Type, Content-Length, Authorization, credential, X-XSRF-TOKEN,keepalive-time,keepalive,clientId,enc-key";
